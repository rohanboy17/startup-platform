  ...
  const meta =
    locale === "hi"
      ? {
          ...
          description: "अकाउंट एक्सेस, विथड्रॉ, campaign billing, job applications, KYC और moderation issues के लिए सहायता प्राप्त करें।",
          accountTitle: "अकाउंट और सुरक्षा",
          walletTitle: "Wallet, funding और payouts",
          campaignTitle: "Campaign, jobs और submission support",
          ...
          bulletsCampaign: ["Campaign और job approval checks", "Application या submission review outcomes", "Interview, rejection और moderation clarification"],
          emailLabel: "ईमेल:",
        }
      : locale === "bn"
        ? {
            ...
            description: "অ্যাকাউন্ট access, withdrawals, campaign billing, job applications, KYC এবং moderation issues-এর জন্য সাহায্য নিন।",
            accountTitle: "অ্যাকাউন্ট ও নিরাপত্তা",
            walletTitle: "Wallet, funding ও payouts",
            campaignTitle: "Campaign, jobs ও submission support",
            ...
            bulletsCampaign: ["Campaign ও job approval checks", "Application বা submission review outcomes", "Interview, rejection ও moderation clarification"],
            emailLabel: "ইমেইল:",
          }
        : {
            eyebrow: "Support Center",
            title: "How Can We Help?",
            description: "Get support for account access, withdrawals, campaign billing, job applications, KYC, and moderation issues.",
            accountTitle: "Account & Security",
            walletTitle: "Wallet, Funding & Payouts",
            campaignTitle: "Campaign, Jobs & Submission Support",
            ...
            bulletsCampaign: ["Campaign and job approval checks", "Application or submission review outcomes", "Interview, rejection, and moderation clarification"],
            emailLabel: "Email:",
          };
