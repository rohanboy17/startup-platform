...
export default function UserSettingsPage() {
  return (
    <div className="space-y-8">
      <div>
        <p className="text-xs font-semibold uppercase tracking-[0.26em] text-foreground/60">User settings</p>
        ...
        <p className="mt-2 max-w-2xl text-sm text-foreground/70 md:text-base">
          Manage your profile, withdrawal defaults, and account security.
        </p>
      </div>
