import UserSkillsPanel from "@/components/user-skills-panel";
import { getTranslations } from "next-intl/server";

export default async function UserSkillsPage() {
  const t = await getTranslations("user.skills");
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-2 max-w-2xl text-sm text-foreground/70 md:text-base">{t("subtitle")}</p>
      </div>
