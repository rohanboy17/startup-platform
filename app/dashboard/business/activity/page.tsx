...
export default async function BusinessActivityPage() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <p className="text-sm uppercase tracking-[0.24em] text-emerald-600/80 dark:text-emerald-300/70">Business timeline</p>
        ...
        <p className="mt-2 max-w-2xl text-sm text-foreground/65 md:text-base">
          Review who changed what across campaigns, jobs, moderation events, funding, and wallet activity.
        </p>
      </div>
