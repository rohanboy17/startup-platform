import ManagerJobApplicationsPanel from "@/components/manager-job-applications-panel";
import { getTranslations } from "next-intl/server";

export default async function ManagerJobsPage() {
  const t = await getTranslations("manager.jobsPage");
