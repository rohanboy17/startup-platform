    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-2 max-w-3xl text-sm text-foreground/65 md:text-base">
          Stay updated on new submissions, flagged activity, and important review alerts.
        </p>
      </div>
      ...
      <div className="grid gap-8 xl:grid-cols-2 xl:items-start">
        ...
        <div className="space-y-4">
          <p className="text-xs uppercase tracking-[0.2em] text-foreground/60">Review alerts</p>
