...
import AdminTaxonomyEditor, { type AdminTaxonomyOptionConfig } from "@/components/admin-taxonomy-editor";
...
export default function AdminCmsPanel({
  ...
  initialWorkTaxonomy: import("@/lib/work-taxonomy").WorkTaxonomyCategory[];
  initialCampaignCategoryOptions: import("@/lib/work-taxonomy").CampaignCategoryOption[];
  initialTaxonomyOptionConfig: AdminTaxonomyOptionConfig;
  flags: FeatureFlag[];
  ...
  return (
    <div className="space-y-8">
      ...
      <AdminTaxonomyEditor
        initialWorkTaxonomy={initialWorkTaxonomy}
        initialCampaignCategoryOptions={initialCampaignCategoryOptions}
        initialTaxonomyOptionConfig={initialTaxonomyOptionConfig}
      />
