...
export default function HomeHeroVisual({ stats }: { stats: HeroStats }) {
  ...
  if (reduceMotion) {
    return (
      <div className="relative mx-auto flex w-full min-w-0 flex-col items-center gap-4 pb-6">
        <div className="relative w-full min-w-0 rounded-[28px] border border-foreground/10 bg-foreground/5 p-4 text-left shadow-[0_20px_60px_rgba(0,0,0,0.18)] sm:rounded-[32px] sm:p-6">
