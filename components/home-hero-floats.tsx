...
function FloatCard({
  ...
  return (
    <div
      className={cn(
        "rounded-2xl border border-foreground/10 bg-background/70 p-3 shadow-[0_8px_20px_rgba(0,0,0,0.14)] backdrop-blur-none sm:p-4 sm:shadow-[0_12px_30px_rgba(0,0,0,0.18)] sm:backdrop-blur",
        className
      )}
    >
