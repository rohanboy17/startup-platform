...
export default function ManagerJobApplicationActions({
  applicationId,
}: {
  applicationId: string;
}) {
  const t = useTranslations("manager.jobApplications.actions");
  ...
  async function review(action: "APPROVE" | "REJECT") {
    ...
    const res = await fetch(`/api/v2/job-applications/${applicationId}/manager`, {
      method: "PATCH",
